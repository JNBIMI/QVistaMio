...
# Form implementation generated from reading ui file 'QvVisualitzacioCapa_ui.ui'
#
...
class Ui_QvVisualitzacioCapa(object):
    def setupUi(self, QvVisualitzacioCapa):
        QvVisualitzacioCapa.setObjectName("QvVisualitzacioCapa")
        QvVisualitzacioCapa.resize(313, 273)
        self.gridLayout_2 = QtWidgets.QGridLayout(QvVisualitzacioCapa)
        self.gridLayout_2.setObjectName("gridLayout_2")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.label = QtWidgets.QLabel(QvVisualitzacioCapa)
        self.label.setObjectName("label")
        self.horizontalLayout.addWidget(self.label)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout.addItem(spacerItem)
        self.txtLayerName = QtWidgets.QLineEdit(QvVisualitzacioCapa)
        ...
        self.frame = QtWidgets.QFrame(QvVisualitzacioCapa)
        ...
        self.label_3 = QtWidgets.QLabel(QvVisualitzacioCapa)
        self.label_3.setWordWrap(True)
        self.label_3.setObjectName("label_3")
        self.horizontalLayout_5.addWidget(self.label_3)
        self.cbTipField = QtWidgets.QComboBox(QvVisualitzacioCapa)
        ...
        self.buttonBox = QtWidgets.QDialogButtonBox(QvVisualitzacioCapa)
        ...
        self.lblDisplayField = QtWidgets.QLabel(QvVisualitzacioCapa)
        self.lblDisplayField.setObjectName("lblDisplayField")
        self.horizontalLayout_2.addWidget(self.lblDisplayField)
        self.cboDisplayFieldName = QtWidgets.QComboBox(QvVisualitzacioCapa)
        ...
        self.label_2 = QtWidgets.QLabel(QvVisualitzacioCapa)
        self.label_2.setMaximumSize(QtCore.QSize(16777215, 20))
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_6.addWidget(self.label_2)
        self.sliderTransparencia = QtWidgets.QSlider(QvVisualitzacioCapa)
        self.sliderTransparencia.setOrientation(QtCore.Qt.Horizontal)
        self.sliderTransparencia.setObjectName("sliderTransparencia")
        self.horizontalLayout_6.addWidget(self.sliderTransparencia)
        self.gridLayout_2.addLayout(self.horizontalLayout_6, 5, 0, 1, 1)

        self.retranslateUi(QvVisualitzacioCapa)
        self.buttonBox.accepted.connect(QvVisualitzacioCapa.accept)
        self.buttonBox.rejected.connect(QvVisualitzacioCapa.reject)
        QtCore.QMetaObject.connectSlotsByName(QvVisualitzacioCapa)
    ...
    def retranslateUi(self, QvVisualitzacioCapa):
        ...
        self.lblMinScale.setText(_translate("QvVisualitzacioCapa", "Escala mínima"))
        self.label_3.setText(_translate("QvVisualitzacioCapa", "Camp a visualitzar quan  passem el cursor per damunt: "))
        self.lblDisplayField.setText(_translate("QvVisualitzacioCapa", "Camp a mostrar"))
        self.label_2.setText(_translate("QvVisualitzacioCapa", "Transparència de la capa"))


if __name__ == "__main__":
    import sys
    app = QtWidgets.QApplication(sys.argv)
    QvVisualitzacioCapa = QtWidgets.QDialog()
    ui = Ui_QvVisualitzacioCapa()
    ui.setupUi(QvVisualitzacioCapa)
    QvVisualitzacioCapa.show()
    sys.exit(app.exec_())
